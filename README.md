...
Since there are not enough I/O pins on the microcontroller to drive the entire matrix directly, the matrix rows (ground paths) are multiplexed using a 74HC595 8-bitshift register. It quickly cycles the active-LOW states with the following sequence
```text
